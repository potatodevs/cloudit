...
public class ListActivity extends BaseActivity {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				try {
					...
					/*}
						...
						CloudAppApplication app = (CloudAppApplication) getApplication();
						app.setURLToOpen(item.getContentUrl());
    	  ...
    	  switch(item.getItemId()) {
	    	  case R.id.copylink:
		    		  ...
		    		  if(sdk < android.os.Build.VERSION_CODES.HONEYCOMB) {
		    		      ...
		    		      android.content.ClipData clip = android.content.ClipData.newPlainText(name + "'s url",url);
	    		        ...
	    		        public void onClick(DialogInterface dialog, int which) {
	    				     ...
	    				     if (networkInfo != null && networkInfo.isConnected()) {
	    				    	 ProgressDialog mProgressDialog;
			  		    		  ...
			  		    		  FileDownloadAsyncTask downloadFile = new FileDownloadAsyncTask(ListActivity.this, mProgressDialog, where, type);
	    	  ...
	    	  case R.id.delete:
		      		...
		      		DeleteAsyncTask del = new DeleteAsyncTask(i);
	      			String[] data = {email, password};
	      			del.execute(data);
    		  
	      			CloudAppApplication app = (CloudAppApplication) getApplication();
	      			app.removeFromList(i);
	      	        items = app.getList();
	      	        adapter = new Adapter(ListActivity.this, items);
    ...
    public void fileDownloaded(String where, boolean isImage) {
	    ...
	    if (isImage) shareIntent.setType("image/*");
	    else shareIntent.setType("*/*");
	    startActivity(Intent.createChooser(shareIntent, getResources().getText(R.string.send_to)));  
    }
