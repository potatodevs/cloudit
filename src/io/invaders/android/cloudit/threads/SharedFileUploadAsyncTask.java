...
import io.invaders.android.cloudit.ShareActivity;
import io.invaders.android.cloudit.Start;
...
public class SharedFileUploadAsyncTask extends AsyncTask<String, Integer, Object> {
	...
	private void notification() {
		...
		NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext)
				.setSmallIcon(R.drawable.notification).setAutoCancel(true).setContentTitle("Cloudit")
